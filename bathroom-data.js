...
export const towelWarmer={id:'H1',wall:'west',x:.065,z:1.850,w:.300,h:.800,y:1.250,projection:.090,towel:{w:.340,bottom:1.090,top:1.790},power:{id:'E3',x:0,z:1.740,h:1.250,kind:'outlet',label:'Питание полотенцесушителя',note:'Предварительный скрытый вывод на боковой стене у тумбы; точную привязку и защиту выбрать по паспорту прибора'}};
export const showerSystem={wall:'east',x:2.94,z:1.30,headX:2.61,headHeight:2.14,mixerHeight:1.10};
const sharedPlane={z:2.180,d:.200};
export const arrangements={
 cabinet:{name:'Единая стена · закрытый шкаф',tag:'НОВЫЙ / ВАШЕ РЕШЕНИЕ',description:'Ровная стена глубиной 200 мм объединяет раковину, WC и душ — без ступенек и открытой полки. Над инсталляцией встроен шкаф шириной 1020 мм; его фасады заподлицо с отделкой. Тумба 850 × 400 мм оставляет 60 мм до края дверного проёма.',screen:{x:1.874,z1:1.280,z2:2.080},entry:{z1:.503,z2:1.280},shower:{wall:'south',x:2.420,z:2.050,headX:2.420,headZ:1.720},gap:null,ledge:null,fullWall:{x:1.485,w:2.970,h:2.650,...sharedPlane},upperCabinet:{x:1.360,w:1.020,y:1.168,h:1.482,...sharedPlane},showerLining:{x:2.420,w:1.100,h:2.650,...sharedPlane},vanity:{x:.425,z:1.880,w:.850,d:.400}},
 protected:{name:'Стекло у WC · общая стена',tag:'С ОТКРЫТОЙ ПОЛКОЙ',description:'Стекло отделяет унитаз от душа. Вход — со стороны шахты; лейка на стене инсталляции. Промежуток 170 мм закрыт добором у стены, над тумбой и инсталляцией проходит общая полка. Место сбоку от WC остаётся свободным.',screen:{x:1.874,z1:1.280,z2:2.080},entry:{z1:.503,z2:1.280},shower:{wall:'south',x:2.420,z:2.050,headX:2.420,headZ:1.720},gap:{x:.935,z:2.180,w:.170,d:.200,h:1.150},ledge:{x:.935,z:2.180,w:1.870,d:.200,h:1.150}},
...
export const designs={
 ...
 clay:{name:'Глина и сталь',tag:'03 / ПРИРОДНЫЙ ЦВЕТ',description:'Светлый матовый камень, приглушённая глиняная стена душа, орех и сатинированный металл. Наша интерпретация природных оттенков и тактильных поверхностей 2026 года.',tradeoff:'Глиняный оттенок — только на правой стене душа. Общая стена остаётся светлой; образец проверяем при тёплом и дневном свете.',wall:'#e4e1d9',floor:'#cdc8be',cabinet:'#75563f',wood:'#75563f',accent:'#b87c68',metal:'#aaaead',shower:'clay',surface:'limestone',materials:['Матовый светлый камень','Натуральный орех','Глиняный керамогранит','Сатинированная сталь']},
 olive:{name:'Олива и орех',tag:'02 / ЦВЕТ И ГЛУБИНА',description:'Приглушённая зелёная плитка в душе, тёмное дерево и нейтральный камень. Ниша становится частью цветной стены.',tradeoff:'Больше швов в душевой; насыщенная стена лучше смотрится с полноценным общим светом.',wall:'#dedbd1',floor:'#c8c3b5',cabinet:'#71513e',wood:'#71513e',accent:'#87917c',metal:'#a0a39b',shower:'tile',surface:'limestone',materials:['Известняк · рисунок','Тёмный орех','Оливковая керамика','Сатинированный металл']}
};
export const views={iso:'Общий вид',door:'От двери',wall:'Общая стена',storage:'Шкаф и шахта',niche:'Полки',shower:'Душ',vanity:'Умывальник',joinery:'Шкаф над WC',detail:'Раковина крупно',towel:'Полотенцесушитель',top:'Сверху'};
export const lights=[
...
export const power=[
 towelWarmer.power,
 {id:'R1',x:.790,z:2.280,h:1.10,kind:'socket',label:'Двойная розетка у тумбы',note:'На стене за тумбой, правее чаши, вне полотенца H1; кандидат после проверки зон'},
