...
export const views={iso:'Общий вид',door:'От двери',storage:'Шкаф и шахта',niche:'Полки',shower:'Душ',vanity:'Умывальник',top:'Сверху'};
export const lights=[
...
export function readState(hash=''){const p=new URLSearchParams(hash.replace(/^#/,''));return {view:Object.hasOwn(views,p.get('view'))?p.get('view'):'iso',light:Object.hasOwn(scenarios,p.get('light'))?p.get('light'):'day',sheet:['layout','light','power','elevation'].includes(p.get('sheet'))?p.get('sheet'):'layout',design:Object.hasOwn(designs,p.get('design'))?p.get('design'):'stone'};}
